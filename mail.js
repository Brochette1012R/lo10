...
exports.buildMail = function(requestSender, objectOwner, annoucement, emailType){
  let mailContent
  let mailType = {
    request : {
      'subject': 'Troc\'UTT - Demande de prêt reçue',
      'text': requestSender.firstName + ' ' + requestSender.lastName + ' souhaite vous empruinter l\'object proposé dans l\'annonce "' + annoucement.title + '." Pour accepter ou refuser l\'offre, connectez vous sur l\'application Troc\'UTT rubrique "Mes annonces" et rendez-vous sur l\'annonce concernée. \n\nAdresse mail de l\'expéditeur de la requête : ' + requestSender.mail,
      'mail' : objectOwner.mail
    },
    acceptedRequest : {
      'subject': 'Troc\'UTT - Demande de prêt acceptée',
      'text': 'Votre demande de prêt concernant l\'objet ' + annoucement.title + 'a été acceptée. Contactez le propiétaire de celui-ci pour fixer une date et un lieu de rendez-vous. \n\nAdresse mail du propriétaire : ' + objectOwner.mail,
      'mail' : requestSender.mail
    },
    refusedRequest : {
      'subject': 'Troc\'UTT - Demande de prêt refusée',
      'text': 'Votre demande de prêt concernant l\'objet ' + annoucement.title + 'n\'a pas été acceptée.',
      'mail' : requestSender.mail
    }
  }
